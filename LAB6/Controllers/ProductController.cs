...
= "https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/mbp14-spacegrayselect-202301?wid=2000&hei=2000&fmt=jpeg&qlt=90" }
        ...
        [HttpGet]
        public IActionResult Filters(string searchValue, string brands, string category, double? minPrice, double? maxPrice, bool? isFreeShipping, int page = 1, int pageSize = 8)
        {
            var result = products.AsQueryable();
            ...
            {
                result = result.Where(p => p.IsFreeShipping == isFreeShipping);
            }
            ...
            return Json(new { products = pagedData, total });
        }
